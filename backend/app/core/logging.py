...
def configure_logging(level: int | str = logging.INFO) -> None:
    ...
    This is idempotent: if the root logger already has handlers the
    function returns immediately to avoid duplicate log lines.
    """
...
def get_logger(name: str) -> logging.Logger:
    ...
    Calling this ensures the global logging configuration is applied.
    """
