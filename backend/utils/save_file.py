...
def save_json(content: Any, filename: str, dir_path: Optional[Union[str, Path]] = None, indent: int = 2) -> Path:
...
def save_text(content: Any, filename: str, dir_path: Optional[Union[str, Path]] = None) -> Path:
